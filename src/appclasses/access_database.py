"""This module (file) has two classes that serve as examples to show
...
class Admin(DatabaseObject):
    ...
    def set_hashed_password(self, value):
        # BCrypt cannot be installed in the Python distribution inside of 
        # Scribus easely.
        # But, outside of Scribus, the line below works OK.
